                    ...
                    <div class="col-lg-6 my-2">
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" aria-label="Default select example" name="status">
                                ...
                                <option value="3"  @php if($requisition->status==3) echo 'selected'; @endphp>Picking</option>
                                <option value="4"  @php if($requisition->status==4) echo 'selected'; @endphp>Delivered</option>
                                <option value="5"  @php if($requisition->status==5) echo 'selected'; @endphp>Cancel</option>
                            </select>
                        </div>
                    </div><!-- col-6 -->
                </div><!-- row -->
