...
{{__('Union Admin')}}
@endsection
@section('unionadminmenu')
active show-sub
@endsection
@section('unionadminlist')
active
@endsection
@section('css')
...
<nav class="breadcrumb sl-breadcrumb">
    ...
    <span class="breadcrumb-item active">{{__('Union')}}</span>
</nav>
    ...
    <div class="card pd-20 pd-sm-40">
      <div class="row">
        ...
        {{--<div class="col-5 text-right">
            <a class="btn btn-info" href="{{ route('admin.unionAdmin.create') }}">{{ __('Create New') }}</a>
        </div>--}}
      </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                    <a title="Show Item" class="mr-2" href="{{route('admin.unionAdmin.show',$data->id)}}"><i class="text-info menu-item-icon icon icon ion-ios-eye tx-24"></i></a>
                    @if(App\Models\Admin::where([['email', $data->email],['name', $data->name]])->count())
                    <a title="Update Item" class="mr-2" href="{{route('admin.unionAdmin.edit',$data->id)}}"><i class="text-success menu-item-icon icon ion-compose tx-24"></i></a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action="{{route('admin.unionAdmin.destroy',$data->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
