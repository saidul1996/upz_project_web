    ...
    <div class="card pd-20 pd-sm-40">
        <div class="row">
            ...
            <div class="col-5 text-right">
                <a class="btn btn-info" href="{{ route('admin.unionAdmin.index') }}">{{__('View All')}}</a>
            </div>
        </div>
        @include('partials.message')
        <form action="{{route('admin.unionAdmin.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-layout">
                ...
                <div class="form-layout-footer">
                    ...
                    <a href="{{ route('admin.unionAdmin.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
