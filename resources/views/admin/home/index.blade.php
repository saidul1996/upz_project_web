        ...
        <div class="col-sm-6 col-xl-3">
          <div class="card pd-20 bg-primary">
            <div class="d-flex justify-content-between align-items-center mg-b-10">
              <h6 class="tx-15 tx-uppercase mg-b-0 tx-spacing-1 tx-white">{{__('Total User')}}</h6>
              <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
            </div><!-- card-header -->
            <div class="d-flex align-items-center justify-content-between">
              <span class="sparkline2">{{ $user['date_row']??'0' }}</span>
              <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $user['total'] }}</h3>
            </div><!-- card-body -->
            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
              <div>
                  <span class="tx-11 tx-white-6">{{__('Today')}}</span>
                  <h6 class="tx-white mg-b-0">{{ $user['today'] }}</h6>
                </div>
                <div>
                  <span class="tx-11 tx-white-6">{{__('Last Month')}}</span>
                  <h6 class="tx-white mg-b-0">{{ $user['last_month'] }}</h6>
                </div>
            </div><!-- -->
          </div><!-- card -->
        </div><!-- col-3 -->
