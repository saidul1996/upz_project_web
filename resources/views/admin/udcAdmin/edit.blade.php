    ...
    <div class="card pd-20 pd-sm-40">
        <div class="row">
            ...
            <div class="col-5 text-right">
                <a class="btn btn-info" href="{{ route('admin.udcAdmin.index') }}">{{__('View All')}}</a>
            </div>
        </div>
        @include('partials.message')
        <form action="{{route('admin.udcAdmin.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-layout">
                ...
                <div class="form-layout-footer">
                    ...
                    <a href="{{ route('admin.udcAdmin.index') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
