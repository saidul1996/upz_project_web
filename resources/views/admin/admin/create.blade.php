...
<div class="sl-pagebody">
    <div class="sl-page-title">
      <!-- <h5>Admin Create</h5>
      <p>Create admin with required field.</p> -->
    </div><!-- sl-page-title -->
                ...
                <div class="row mg-b-25">
                    <div class="col-lg-6 my-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="{{__('Enter User Name')}}">
                        </div>
                    </div><!-- col-6 -->
                    <div class="col-lg-6 my-2">
                        <div class="form-group">
                            <label class="form-control-label">{{__('Email')}}: <span class="tx-danger"></span></label>
                            <input class="form-control" type="text" name="email" value="{{ old('email') }}" placeholder="{{__('Enter User Email')}}">
                        </div>
                    </div><!-- col-6 -->
                    <div class="col-lg-6 my-2">
                        <div class="form-group">
                            <label class="form-control-label">{{__('Password')}}: <span class="tx-danger"></span></label>
                            <input class="form-control" type="password" name="password" value="{{ old('password') }}" placeholder="{{__('Enter User Password')}}">
                        </div>
                    </div><!-- col-6 -->
                </div><!-- row -->
