        ...
        <table id="example" class="table display responsive nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a title="Show Item" class="mr-2" href="{{route('admin.admin.show',$data->id)}}"><i class="text-info menu-item-icon icon icon ion-ios-eye tx-24"></i></a>
                    <a title="Update Item" class="mr-2" href="{{route('admin.admin.edit',$data->id)}}"><i class="text-success menu-item-icon icon ion-compose tx-24"></i></a>
                    @if(Auth()->id()!=$data->id)
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action="{{route('admin.admin.destroy',$data->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
