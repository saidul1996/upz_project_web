        ...
        <table id="example" class="table display responsive nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a title="Show Item" class="mr-2" href="{{route('admin.product.show',$data->id)}}"><i class="text-info menu-item-icon icon icon ion-ios-eye tx-24"></i></a>
                    <a title="Update Item" class="mr-2" href="{{route('admin.product.edit',$data->id)}}"><i class="text-success menu-item-icon icon ion-compose tx-24"></i></a>
